...
class MolecularDynamics(object):
    def __init__(self, RadiusCutoff:float = 1,
        ...
        self.velocity = 2 * numpy.random.random((self._N, 3)) - 1
    ...
    def _lennard_jones_force(self, r:numpy.ndarray):
        _f = 48 * self._EPS * (numpy.power(self._SIG / r, 12) - 1 / 2 * numpy.power(self._SIG / r, 6))
        return _f
    ...
    def update(self):
        ...
        self.velocity = self.velocity + self._H * (_temp4 + self._force) / 2
